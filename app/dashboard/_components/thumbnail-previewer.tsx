...
import { Laptop, TabletSmartphone, Smartphone } from "lucide-react";
...
const ThumbnailPreviewer = ({
  ...
  const getGridClass = () => {
    switch (layout) {
      ...
      case "mobile":
        return "grid-cols-1 max-w-[340ox] mx-auto";
      default:
    ...
    <div className="relative w-full h-full bg-background text-foreground">
      ...
      <div className="grid md:grid-cols-2 gap-6 border-b border-white/20 pb-12">
        ...
        <div>
          ...
          <div className="aspect-w-16 aspect-h-6 rounded-lg overflow-hidden w-[60%]">
            <img
      ...
      {/* Randomized Order and Layout Selection */}
      <div className="mb-6 flex items-center space-x-4 max-w-[1200px] mx-auto mt-3">
        <Button onClick={randomizeOrder}>Randomized Order</Button>
