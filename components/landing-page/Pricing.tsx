    ...
    <section className="max-w-7xl mx-auto py-24 px-4 relative">
      ...
      >
        <div className="flex flex-row gap-6 items-center ">
          <h2 className="p-3 text-2xl font-medium text-primary tracking-wider">
            Pricing
          </h2>
      ...
      <AnimationContainer delay={0.2} className="flex justify-center w-full">
        <div className="space-y-6 w-full md:w-[500px] relative p-8 transition-all duration-300 bg-background/30 hover:bg-white/5 background-blur-sm shadow-lg hover:shadow-xl rounded-2xl border border-white/10">
