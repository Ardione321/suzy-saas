...
import thumbail1 from "@/app/assets/1.png";
import thumbail2 from "@/app/assets/2.png";
import thumbail3 from "@/app/assets/3.png";
import { Pencil, Layout, Eye } from "lucide-react";
import AnimationContainer from "../global/animation-container";

const StepsArray = [
  { icon: Pencil, step: "Step 1", description: "", image: thumbail1 },
  { icon: Layout, step: "Step 2", description: "", image: thumbail2 },
  { icon: Eye, step: "Step 3", description: "", image: thumbail3 },
];
...
export function Steps() {
  return (
    <AnimationContainer className="md:mx-48 mt-20 relative">
      ...
      <div className="absolute right-1/3 top-[10%] bottom-[10%] w-[1px] bg-gradient-to-b from-transparent via-foreground to transparent" />
      ...
      <AnimationContainer delay={0.2} className="grid md:grid-cols-3">
        ...
        {StepsArray.map((step, index) => (
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 p-4 rounded-2xl border boder-primary/10">
              <div className="p-2 bg-primary/10 rounded-xl">
                <Pencil className="h-5 w-4 text-primary" />
              </div>
